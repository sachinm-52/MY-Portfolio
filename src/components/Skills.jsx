...
const skillCategories = [
  ...
  { 
    ...
    desc: 'Building intelligent data solutions leveraging analytics, predictive modeling, NLP, and scalable AI-powered data pipelines.', 
    tag: 'INTELLIGENCE',
    skills: ['Data Analytics', 'Predictive Modeling', 'NLP', 'AI Pipelines', 'Python'] 
  },
  { 
    title: 'Cloud & DevOps', 
