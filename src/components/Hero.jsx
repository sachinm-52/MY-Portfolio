...
const Hero = () => {
  ...
  const developerRoles = [
    'FEATURE FILM // DATA ENGINEER',
    'ORIGINAL SERIES // AI & DS SPECIALIST',
    'BLOCKBUSTER // DATA PIPELINES',
    'ACCLAIMED // AI-POWERED APPLICATIONS'
  ];
    ...
    >
      ...
      <div ref={contentRef} className="relative z-20 w-full max-w-7xl mx-auto px-6 md:px-12 h-full flex flex-col justify-between pt-24 pb-12">
        ...
        <div className="hero-anim-item flex items-center justify-between w-full">
          ...
          <div className="hidden md:flex items-center gap-2 text-xs font-mono text-white/50 tracking-wider">
            ...
            <span className="px-2 py-0.5 border border-white/20 rounded bg-black/40">AI / DS CERTIFIED</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 items-center gap-8 my-auto">
          ...
          <div className="lg:col-span-5 flex flex-col items-start space-y-5 text-left">
            ...
            <div className="hero-anim-item flex items-center gap-3">
              ...
              <span className="text-white/80 text-xs font-mono tracking-widest uppercase">Data Engineer & AI Enthusiast</span>
            </div>
            ...
            <div className="hero-anim-item flex items-center gap-3 text-xs font-mono text-red-400 font-bold">
              ...
              <span className="text-white/40">•</span>
              <span>Python • SQL • Spark</span>
              <span className="text-white/40">•</span>
              <span className="text-white/70">Data Pipelines & AI</span>
            </div>

            <p className="hero-anim-item text-sm md:text-base text-white/80 font-light leading-relaxed max-w-md drop-shadow">
              Building data-driven systems, AI-powered applications & scalable data solutions. Computer Science / AI & Data Science student passionate about Data Engineering, AI and Analytics.
            </p>
            ...
            {/* Social Links */}
            <div className="hero-anim-item flex items-center gap-5 pt-1">
              <a href="https://www.linkedin.com/in/sachin-mamadapur-21a0bb302" target="_blank" rel="noopener noreferrer" className="text-white/50 hover:text-red-500 transition-colors duration-300 hover:scale-110 active:scale-95" aria-label="LinkedIn">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
              </a>
              <a href="https://x.com/@SMamadapur29180" target="_blank" rel="noopener noreferrer" className="text-white/50 hover:text-red-500 transition-colors duration-300 hover:scale-110 active:scale-95" aria-label="X / Twitter">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
              </a>
              <a href="https://www.instagram.com/sachinnm_00" target="_blank" rel="noopener noreferrer" className="text-white/50 hover:text-red-500 transition-colors duration-300 hover:scale-110 active:scale-95" aria-label="Instagram">
          ...
          <div className="hero-anim-item lg:col-span-3 flex flex-col items-start lg:items-end space-y-4 text-left lg:text-right">
            <div className="p-5 bg-black/80 backdrop-blur-2xl border border-white/15 rounded-xl shadow-2xl max-w-xs">
              ...
              <p className="text-xs text-white/80 leading-relaxed font-light">
                Data Engineer • AI & Data Science • Scalable Data Solutions • Bengaluru, India.
              </p>
            </div>
          </div>
      ...
      <header className="absolute top-0 left-0 z-50 w-full max-w-7xl mx-auto px-6 md:px-12 py-6 flex items-center justify-between pointer-events-auto">
        <div className="text-2xl font-black text-red-600 tracking-tighter flex items-center gap-2 drop-shadow-[0_2px_15px_rgba(229,9,20,0.9)]">
          SACHIN<span className="w-1.5 h-1.5 rounded-full bg-white inline-block"></span>
        </div>
        <nav className="hidden md:flex items-center gap-8 text-xs font-mono uppercase tracking-widest text-white/80">
          ...
          <a href="#github" className="hover:text-red-500 transition-colors">GitHub</a>
