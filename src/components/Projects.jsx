...
const projectsData = [
  ...
  {
    title: "AI & DS Analytics Pipeline",
    category: "Data Science & AI",
    description: "Intelligent data processing pipeline leveraging data science models, analytics workflows, and AI-powered insights.",
    tags: ["Python", "Data Science", "NLP", "Analytics"],
    match: "96%",
    episode: "S01 E05"
  },
  {
