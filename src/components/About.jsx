        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          >
            ...
            <div className="space-y-5 relative z-10">
              ...
              <p className="text-lg md:text-xl font-medium text-white/90 leading-relaxed">
                I am <span className="text-white font-bold drop-shadow">Sachin Mamadapur</span>, a Computer Science / AI & Data Science student passionate about Data Engineering, AI and Analytics from Bengaluru, Karnataka, India.
              </p>
              <p className="text-sm md:text-base text-white/60 font-light leading-relaxed">
                My technical narrative bridges building data-driven systems and AI-powered applications with scalable data solutions, translating complex data pipelines into actionable insights and high-performance systems.
              </p>
            </div>
            
            <div className="pt-8 flex flex-wrap gap-2 relative z-10">
              <span className="px-3.5 py-1.5 rounded bg-white/5 border border-white/10 text-xs font-mono text-white/80">AI & DS</span>
              <span className="px-3.5 py-1.5 rounded bg-white/5 border border-white/10 text-xs font-mono text-white/80">Data Engineering</span>
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-3 relative z-10">
              {['Python', 'SQL', 'Spark', 'PostgreSQL', 'MongoDB', 'Docker', 'Airflow'].map((tech, idx) => (
                <span
                  key={idx}
